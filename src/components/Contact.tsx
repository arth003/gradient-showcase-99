          ...
          <div className="bg-card rounded-3xl p-8 md:p-12 border border-border gradient-border">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-3xl md:text-4xl font-bold text-foreground font-space">
                  Get In Touch
                </h3>
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-6">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`flex items-center gap-2 px-6 py-3 bg-muted rounded-full text-foreground ${social.color} transition-colors duration-300 border border-border hover:border-primary/50`}
                  >
