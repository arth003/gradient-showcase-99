      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className=" relative order-1 md:order-2 flex justify-center md:justify-end pt-28 sm:pt-32 md:pt-0">
            <div className=" relative w-full max-w-[220px] sm:max-w-xs md:max-w-[280px] lg:max-w-[320px] md:translate-x-6">
              <div className="absolute inset-0 gradient-bg opacity-20 blur-2xl md:blur-3xl rounded-3xl" />
              <img
                src={profileImg}
                alt="Arth Nangar"
                className="relative w-full rounded-2xl shadow-2xl gradient-border"
              />
            </div>
          </motion.div>
        </div>
